...
class Visualiser(nn.Module):
    ...
    def save(self):
        torch.save(self.state_dict(), "models/visualiser_200.pth")
        print("saving trained model as models/visualiser_200.pth !")
        return
    def load(self):
        if os.path.exists("models/visualiser_200.pth"):
        ...
        print("loaded presaved model from models/visualiser_200.pth !")
        return
