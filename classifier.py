...
class Classifier(nn.Module):
    ...
    def save(self):
        torch.save(self.state_dict(), "classifier.pth")
        print("saving trained model as classifier.pth !")
        return
    
    def load(self):
        if os.path.exists("classifier.pth"):
            self.load_state_dict(torch.load("classifier.pth"))
        else:
        ...
        print("loaded presaved model from classifier.pth !")
        return
